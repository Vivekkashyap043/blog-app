          ...
          <div className="col" key={article.articleId}>
            <div className="card h-100">
              <div className="card-body">
                ...
                <button className="btn btn-outline-primary" onClick={()=>readArticleByArticleId(article)}>
                  <span>Read More</span>
                </button>
              </div>
              <div className="card-footer" style={{background:"linear-gradient(to right, #151B54, #4863A0)"}}>
