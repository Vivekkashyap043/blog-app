              ...
              <form onSubmit={handleSubmit(postNewArticle)}>
                ...
                <div className="mb-4">
                  ...
                  >
                    ...
                    <option value="database">Maths</option>
                    <option value="database">Physics</option>
                    <option value="database">Chemistry</option>
                    <option value="database">Environment</option>
                    <option value="database">Bussiness</option>
                    <option value="database">Law</option>
                    <option value="database">Song</option>
                    <option value="database">Sports</option>
                    <option value="database">Religion</option>
                    <option value="database">Social issue</option>
                    <option value="database">Other</option>
                  </select>
                </div>
                <div className="mb-4">
